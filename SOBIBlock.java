...
public final class SOBIBlock
{
    ...
    private SOBIBlock(String line) {
        this.Year=Integer.parseInt(line.substring(0,4));
        this.PrintNo=line.substring(4,10);
        this.Amendment=line.substring(10,11).trim();
        this.BillHeader=line.substring(0, 11);
        this.Type=line.charAt(11);
        this.Header=line.substring(0,12);
        this.Data=line.substring(12);
        multiline =line.contains(line) ;
                }
